...
cron.schedule('28 7 29 10 *', () => {
  const message = 
    ...
    + '🕒 <b>Начало:</b> 30 октября в 10:00 по МСК (15:00 ИРК)\n'
    + '🎙 <b>Спикер:</b> Колганова Наталья\n'
    + '🔗 <b>Ссылка на трансляцию:</b> https://telemost.yandex.ru/j/26231226134771'
...
// cron.schedule('0 7 30 10 *', () => {
  cron.schedule('13 19 13 10 *', () => {
  const message = 
    '⏳ До начала вебинара «Лучшие практики по соблюдению принципов ХАССП на пищевых производствах и предприятиях общественного питания» осталось 3 часа.\n\n'
    + '🎙 <b>Спикер:</b> Колганова Наталья\n'
    + '🔗 <b>Присоединиться:</b> https://telemost.yandex.ru/j/26231226134771'
...
// cron.schedule('0 9 30 10 *', () => {
  cron.schedule('13 19 13 10 *', () => {
  const message = 
    '⚡ Вебинар «Лучшие практики по соблюдению принципов ХАССП на пищевых производствах и предприятиях общественного питания» начнется через 1 час!\n\n'
    + '🎙 <b>Спикер:</b> Колганова Наталья\n'
    + '🔗 <b>Присоединиться:</b> https://telemost.yandex.ru/j/26231226134771'
...
// cron.schedule('55 9 30 10 *', () => {
  cron.schedule('13 19 13 10 *', () => {
  const message = 
    '🚀 Вебинар «Лучшие практики по соблюдению принципов ХАССП на пищевых производствах и предприятиях общественного питания» стартует через 5 минут!\n\n'
    + '🎙 <b>Спикер:</b> Колганова Наталья\n'
    + '🔗 <b>Присоединиться:</b> https://telemost.yandex.ru/j/26231226134771'
